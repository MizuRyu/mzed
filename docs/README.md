...
| ファイル | 内容 | 最終確認 |
|---|---|---|
| [00-overview.md](specs/00-overview.md) | 概要・索引・決定事項 | 2026-09-12 |
| [01-architecture.md](specs/01-architecture.md) | システム構成・データフロー | 2026-09-12 |
| [02-tech-stack.md](specs/02-tech-stack.md) | 技術選定と理由 | 2026-07-02 |
| [03-features.md](specs/03-features.md) | 機能一覧（v1 + 将来検討） | 2026-09-12 |
| [04-project-structure.md](specs/04-project-structure.md) | ディレクトリ・モジュール・設定スキーマ | 2026-09-12 |
...
| [10-settings-and-context-menu.md](specs/10-settings-and-context-menu.md) | 設定画面・右クリック・キーバインド・オーバーレイ選択 | 2026-09-12 |
...
| [manual-test-cases.md](specs/manual-test-cases.md) | 恒久手動テストケース集（TC-ID 付き） | 2026-09-12 |
